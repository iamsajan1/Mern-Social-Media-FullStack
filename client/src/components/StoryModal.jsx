...
const StoryModal = ({ setShowModal, fetchStories }) => {
  const bgColors = ["blue", "red", "yellow", "green", "pink"];
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex gap-2 mt-4">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-4  cursor-pointer
            p-2 rounded ${
          ...
          <label className={`flex-1 flex items-center justify-center gap-4
            p-2 rounded ${mode==='media' ? 'bg-white text-black' : 'bg-zinc-800'} cursor-pointer`}>
        ...
        py-3 mt-4 rounded bg-gradient-to-r from-indigo-500 to-purple-500
        hover:from-purple-500 hover:to-indigo-500 w-full active:scale-95
